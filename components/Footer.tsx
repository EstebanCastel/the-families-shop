...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-neutral-200 bg-white">
      <div className="mx-auto grid max-w-[1400px] gap-10 px-4 py-14 md:grid-cols-4 md:px-8">
        <div>
          ...
          <ul className="space-y-2 text-[13px] text-neutral-500">
            <li><Link href="/novedades" className="hover:text-black">Novedades</Link></li>
            {categories.map((c) => <li key={c.id}><Link href={`/categoria/${c.id}`} className="hover:text-black">{c.label}</Link></li>)}
          </ul>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-[13px] text-neutral-500">
            ...
            <li><a href="https://www.instagram.com/t.families/" target="_blank" rel="noreferrer" className="hover:text-black">Instagram</a></li>
            <li>Sostenibilidad</li>
          </ul>
        </div>
        <div>
          <p className="tnav mb-4">Newsletter</p>
          <p className="mb-3 text-[13px] text-neutral-500">Suscríbete y recibe novedades del archivo.</p>
      ...
      <div className="border-t border-neutral-200 px-4 py-5 text-center text-[11px] text-neutral-500 md:px-8">
